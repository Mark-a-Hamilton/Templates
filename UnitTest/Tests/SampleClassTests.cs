...
public class SampleClassTests
{
     ...
     * 5) Once the test is generated this provides a starting point  now inline data can be added to comprehensively test the method.
     * WARNING - AI is a tool don't expect the test to be comprehensive so step 5 is paramount. 
     */
